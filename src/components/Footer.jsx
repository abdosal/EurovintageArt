    ...
    <footer className="footer">
      <div className="container footer-inner">
        ...
        <div className="footer-brand">
          <Link to="/">
            <img src="/eurovintage.png" alt="EuroVintage Art" className="footer-logo" />
          </Link>
          ...
          <div className="footer-socials">
            ...
            <a href="mailto:contact@eurovintage-art.com" aria-label="Email">
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p>© 2026 <span className="euro-text">Euro</span>Vintage Art — Tous droits réservés</p>
